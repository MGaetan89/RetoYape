...
const val LOCATION_RECIPE_TITLE = "locationRecipeTitle"
...
class RecipeDetailFragment : Fragment(R.layout.fragment_recipe_detail) {
    ...
    private fun initListener() {
        ...
        binding.btnLocation.setOnClickListener {
            val bundle = bundleOf(
                LOCATION_RECIPE_LATITUDE to dataRecipe.latitude,
                LOCATION_RECIPE_LONGITUDE to dataRecipe.longitude,
                LOCATION_RECIPE_TITLE to dataRecipe.name
            )
